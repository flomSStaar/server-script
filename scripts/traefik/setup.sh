...
sed -i -E "s/TRAEFIK_BASIC_AUTH_USER/${TRAEFIK_BASIC_AUTH_USER}/" "$SERVICES_DIR/traefik/traefik-basic-auth.yml"
sed -i -E "s/TRAEFIK_BASIC_AUTH_PASSWORD/${TRAEFIK_BASIC_AUTH_PASSWORD}/" "$SERVICES_DIR/traefik/traefik-basic-auth.yml"
